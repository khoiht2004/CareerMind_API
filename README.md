...
- **Nhà tuyển dụng (Recruiter):** sàng lọc hồ sơ, đặt câu hỏi phỏng vấn tự động.

Backend được xây dựng bằng **Node.js + Express**, sử dụng **Prisma ORM** với **MySQL**, hỗ trợ hệ thống xác thực đầy đủ, quản lý phiên đa thiết bị và chat AI theo session.
